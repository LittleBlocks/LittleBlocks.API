...
namespace LittleBlocks.AspNetCore.UnitTests.Logging.SeriLog;
...
public sealed class LogInterceptorTests : IClassFixture<ServiceCollectionFixture>
{
    ...
    public async Task GivenSut_WhenAsyncMethodCalledAndThrows_ThenLogFailedExecution()
    {
        ...
        Assert.Collection(Fixture.Log.Logs, s =>
        {
            ...
            Assert.Contains("Executing 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndThrowAsync' ...", s);
        }, s =>
        {
            Assert.Contains("Error", s);
            Assert.Contains(
                "Failed to execute 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndThrowAsync'!" +
                " 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeException' has been thrown.", s);
        });
        ...
        GivenSut_WhenAsyncMethodCalledWithoutParameters_AndLogLevelSetToTrace_ThenLogThatMethodHasNoParameters()
    {
        ...
        {
            Assert.Contains("Debug", s);
            Assert.Contains("Executing 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAsync' ...", s);
        }, s =>
        {
        ...
        {
            Assert.Contains("Debug", s);
            Assert.Contains("'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAsync' execution completed.", s);
        }, s =>
        {
            Assert.Contains("Trace", s);
            Assert.Contains(
                "'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAsync' is VOID and has no return value.", s);
        });
        ...
        GivenSut_WhenAsyncMethodWith_CustomClass_ArgumentsCalled_ThenLogMethodArguments_AndReturnValue()
    {
        ...
        Assert.Collection(Fixture.Log.Logs, s =>
        {
            Assert.Contains("Debug", s);
            Assert.Contains(
                "Executing 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndReturnResultAsync' ...", s);
        }, s =>
        {
            Assert.Contains("Trace", s);
        ...
        }, s =>
        {
            Assert.Contains("Debug", s);
            Assert.Contains(
                "'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndReturnResultAsync' execution completed.",
                s);
        }, s =>
        {
            Assert.Contains("Trace", s);
    ...
    public async Task GivenSut_WhenAsyncMethodWith_Integer_ArgumentsCalled_ThenLogMethodArguments_AndReturnValue()
    {
        ...
        }, s =>
        {
            Assert.Contains("Trace", s);
            Assert.Contains(
                $"Result for 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndReturnResultAsync' is: {value}.",
                s);
        });
    ...
    public async Task GivenSut_WhenAsyncMethodWithArgumentsCalledAndThrows_ThenLogFailedExecution()
    {
        ...
        Assert.Collection(Fixture.Log.Logs, s =>
        {
            Assert.Contains("Debug", s);
            Assert.Contains(
                "Executing 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndThrowInsteadOfReturnResultAsync' ...",
                s);
        }, s =>
        {
            Assert.Contains("Trace", s);
        ...
        }, s =>
        {
            Assert.Contains("Error", s);
            Assert.Contains(
                "Failed to execute 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndThrowInsteadOfReturnResultAsync'!" +
                " 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeException' has been thrown.", s);
        });
    ...
    public void GivenSut_WhenSyncMethodCalled_ThenLogMethodExecutionStartAndEnd()
    {
        ...
        {
            Assert.Contains("Debug", s);
            Assert.Contains("Executing 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.Call' ...", s);
        }, s =>
        {
            Assert.Contains("Debug", s);
            Assert.Contains("'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.Call' execution completed.", s);
        });
    ...
    public void GivenSut_WhenSyncMethodCalledAndThrows_ThenLogFailedExecution()
    {
        ...
        {
            Assert.Contains("Debug", s);
            Assert.Contains("Executing 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndThrow' ...", s);
        }, s =>
        {
            Assert.Contains("Error", s);
            Assert.Contains("Failed to execute 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndThrow'!" +
                            " 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeException' has been thrown.", s);
        });
        ...
        GivenSut_WhenSyncMethodCalledWithoutParameters_AndLogLevelSetToTrace_ThenLogThatMethodHasNoParameters()
    {
        ...
        }, s =>
        {
            Assert.Contains("Trace", s);
            Assert.Contains(
                "'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.Call' is VOID and has no return value.", s);
        });
    ...
    public void GivenSut_WhenSyncMethodWith_CustomClass_ArgumentsCalled_ThenLogMethodArguments_AndReturnValue()
    {
        ...
        {
            Assert.Contains("Debug", s);
            Assert.Contains("Executing 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndReturnResult' ...",
                s);
        }, s =>
        {
            Assert.Contains("Trace", s);
        ...
        }, s =>
        {
            Assert.Contains("Debug", s);
            Assert.Contains(
                "'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndReturnResult' execution completed.", s);
        }, s =>
        {
            Assert.Contains("Trace", s);
            Assert.Contains(argument.Value, s);
    ...
    public void GivenSut_WhenSyncMethodWith_Integer_ArgumentsCalled_ThenLogMethodArguments_AndReturnValue()
    {
        ...
        }, s =>
        {
            Assert.Contains("Trace", s);
            Assert.Contains(
                $"Result for 'LittleBlocks.AspNetCore.UnitTests.Helpers.FakeService.CallAndReturnResult' is: {value}.",
                s);
        });
